...
│   ├── sw.js                   # PWA Service Worker (v49.38 cache-first static assets & network-first HTML)
...
│   ├── js/
│   │   ├── script.js           # Core site engine: nav, theme toggle, access control, Google Sign-In & search (v49.38)
